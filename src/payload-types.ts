...
export interface CalendarBlock {
   ...
   */
  dataSource?: ('all' | 'upcoming' | 'category') | null;
  /**
...
export interface GalleryBlock {
  title?: string | null;
  /**
   * Choose how to populate gallery media
   */
  dataSource?: ('all' | 'event' | 'all-events' | 'selection') | null;
  /**
   * Select an event to show media for
   */
  selectedEvent?: (string | null) | Event;
  /**
   * Select specific media items to display
   */
  selectedMedia?: (string | Media)[] | null;
  /**
   * Choose the layout style for the gallery
   */
